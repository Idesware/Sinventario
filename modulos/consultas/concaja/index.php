...
<body>
    ...
    <div class="container" align="center">
		<div class="control-group well span11">
			...
			<div class="page-header"> <h4>REPORTE DE MOVIMIENTOS CAJA</h4>
            <br/>
                <div class="row-fluid">
                	<div class="span3">
    ...
    <input type="hidden" id="Url" value="<?php echo $RUTAm."consultas/concaja/funciones/funciones.php"; ?>">
    <input type="hidden" id="Url_detalle" value="<?php echo $RUTAm."consultas/concaja/funciones/funciones_detalle.php"; ?>">
    <input type="hidden" id="id_suc" value="<?php echo $sucursal['suc_id']; ?>">
    <input type="hidden" id="url_autocomplete" value="<?php echo $RUTAm."consultas/concaja/funciones/autocomplete-vendedor.php"; ?>">
