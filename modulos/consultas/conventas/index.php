...
<body>
    ...
    <input type="hidden" id="Url" value="<?php echo $RUTAm."consultas/conventas/funciones/funciones.php"; ?>">
    <input type="hidden" id="Url_detalle" value="<?php echo $RUTAm."consultas/conventas/funciones/funciones_detalle.php"; ?>">
    <input type="hidden" id="id_suc" value="<?php echo $sucursal['suc_id']; ?>">
    <input type="hidden" id="url_autocomplete" value="<?php echo $RUTAm."consultas/conventas/funciones/autocomplete-vendedor.php"; ?>">
