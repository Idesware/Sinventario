<?php
	...
	if($referencia == "") {
		...
		$consulta = sprintf("SELECT cab_ven_id,cab_ven_ref,per_nombre,cab_ven_fecha, cab_ven_total FROM cabecera_ventas  
	   ...
	   while($fila = mysql_fetch_array($result, MYSQL_ASSOC)) {
		 	...
		 	$respuesta->rows[$i]['id']=$fila['cab_ven_id'];
		   	$respuesta->rows[$i]['cell']=array($fila["cab_ven_id"],$fila["cab_ven_ref"],$fila["per_nombre"],$fila["cab_ven_fecha"],$fila["cab_ven_total"]);
			$i++;
	  } 
	}
	else
	{
	   ...
	   while($fila = mysql_fetch_array($result, MYSQL_ASSOC)) {
		  ...
		  $respuesta->rows[$i]['id']=$fila['cab_ven_id'];
		   $respuesta->rows[$i]['cell']=array($fila["cab_ven_id"],$fila["cab_ven_ref"],$fila["cli_id"],$fila["cab_ven_fecha"],$fila["cab_ven_total"]);
			$i++;
	  } 	
	}
